...
class WeatherProvider with ChangeNotifier {
  ...
  Future<void> _bootstrap() async {
    ...
    if (_lastUpdated == null) {
      _lastUpdated = DateTime(2026, 9, 7, 8, 0);
    }
    await refreshData();
  }
  ...
  List<City> _buildApimsFallbackReadings() {
    ...
    return [
      ...
      station('Alor Setar', 'Kedah', 62, 'PM2.5', 31, 79, 9, 6.1248, 100.3678),
      station(
        'Sungai Petani',
        'Kedah',
        75,
      ...
      station('Kulim', 'Kedah', 91, 'PM2.5', 31, 80, 10, 5.3649, 100.5618),
      station('Kangar', 'Perlis', 45, 'PM10', 32, 77, 11, 6.4414, 100.1986),
      station('Arau', 'Perlis', 45, 'PM10', 31, 78, 10, 6.4297, 100.2698),
      station('Ipoh', 'Perak', 163, 'PM10', 31, 76, 9, 4.5975, 101.0901),
      station('Taiping', 'Perak', 153, 'PM2.5', 29, 84, 8, 4.8519, 100.7414),
      station(
        'Seri Manjung',
        'Perak',
        165,
      ...
      station('Klang', 'Selangor', 160, 'PM10', 33, 76, 13, 3.0449, 101.4456),
      station(
        'Petaling Jaya',
        'Selangor',
        157,
      ...
      station('Banting', 'Selangor', 158, 'PM10', 32, 78, 10, 2.8136, 101.5019),
      station(
        'Kuala Selangor',
        'Selangor',
        157,
      ...
      station('Melaka', 'Melaka', 115, 'PM10', 31, 80, 10, 2.1896, 102.2501),
      station(
        'Bukit Rambai',
        'Melaka',
        155,
      ...
      station('Alor Gajah', 'Melaka', 153, 'PM10', 30, 80, 9, 2.3804, 102.2089),
      station('Segamat', 'Johor', 155, 'PM2.5', 32, 78, 12, 2.4650, 102.9010),
      station('Johor Bahru', 'Johor', 85, 'PM10', 33, 77, 15, 1.4927, 103.7414),
      station(
        'Pasir Gudang',
        'Johor',
        85,
      ...
      station('Kluang', 'Johor', 113, 'PM10', 32, 79, 11, 2.0305, 103.3169),
      station('Batu Pahat', 'Johor', 154, 'PM2.5', 31, 80, 10, 1.8548, 102.9325),
      station('Muar', 'Johor', 70, 'PM10', 31, 81, 10, 2.0442, 102.5689),
      station(
        'Kota Tinggi',
        'Johor',
        75,
      ...
      station('Kuantan', 'Pahang', 78, 'PM10', 31, 83, 11, 3.8077, 103.3260),
      station('Temerloh', 'Pahang', 99, 'PM2.5', 31, 82, 9, 3.4486, 102.4160),
      station('Jerantut', 'Pahang', 77, 'PM10', 30, 84, 8, 3.9360, 102.3626),
      ...
      station('Paka', 'Terengganu', 92, 'PM10', 30, 83, 10, 4.6374, 103.4368),
      station(
        'Kota Bharu',
        'Kelantan',
        75,
      ...
      station('Kuching', 'Sarawak', 200, 'NO2', 30, 84, 8, 1.5533, 110.3592),
      station('Sibu', 'Sarawak', 184, 'PM2.5', 31, 86, 7, 2.2876, 111.8305),
      station('Miri', 'Sarawak', 167, 'PM10', 31, 83, 9, 4.3995, 113.9914),
      station('Samarahan', 'Sarawak', 237, 'PM2.5', 30, 85, 8, 1.4610, 110.4980),
      station('Bintulu', 'Sarawak', 167, 'PM10', 31, 84, 9, 3.1713, 113.0419),
      station('Sri Aman', 'Sarawak', 191, 'PM2.5', 31, 86, 7, 1.2376, 111.4621),
      station('Limbang', 'Sarawak', 149, 'PM10', 30, 83, 8, 4.7500, 115.0000),
      station(
        'Kota Kinabalu',
        'Sabah',
        152,
      ...
      station('Tawau', 'Sabah', 81, 'O3', 31, 81, 8, 4.2447, 117.8912),
      station('Sandakan', 'Sabah', 76, 'PM10', 31, 82, 8, 5.8394, 118.1172),
      station('Keningau', 'Sabah', 84, 'PM2.5', 30, 84, 7, 5.3378, 116.1602),
      station('Kimanis', 'Sabah', 151, 'PM10', 31, 83, 9, 5.5720, 115.9500),
      station(
        'Labuan',
        'W.P. Labuan',
        154,
