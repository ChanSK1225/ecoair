                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(widget.product.category, style: TextStyle(color: Colors.teal[700], fontSize: 10, fontWeight: FontWeight.bold)),
                          ),
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(' ${widget.product.rating}', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ],
                      ...
                      Text('RM ${widget.product.price.toStringAsFixed(2)}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF0F9D58))),
                      const SizedBox(height: 4),
                      Text('${widget.product.stock} in stock', style: const TextStyle(color: Colors.grey, fontSize: 12)),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('Total: RM ${(widget.product.price * _quantity).toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () {
                        Provider.of<StoreProvider>(context, listen: false).addToCart(widget.product, quantity: _quantity);
